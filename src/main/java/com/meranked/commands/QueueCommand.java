...
public final class QueueCommand implements CommandExecutor, TabCompleter {
    ...
    public QueueCommand(ServiceRegistry services) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        String gamemode = args[0].substring(0, 1).toUpperCase() + args[0].substring(1).toLowerCase();
        services.queue().joinQueue(player, gamemode);
        return true;
    }
